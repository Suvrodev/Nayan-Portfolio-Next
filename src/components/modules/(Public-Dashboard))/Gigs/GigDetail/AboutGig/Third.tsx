...
const Third = () => {
  return (
    <div className="prose prose-sm md:prose-base lg:prose-lg prose-invert max-w-none pDesc">
      ...
      <p className="mt-2">
        I will do luxury business card and logo design in 24 hours
      </p>
      ...
      <ol className="list-decimal pl-6 ">
        ...
        <li>
          Single or Double-sided business card designs letterhead and logo
          design
        </li>
        <li>Fully editable source file (AI, PSD)</li>
        <li>Horizontal or Vertical layout</li>
        <li>Unlimited revision until your satisfaction</li>
      </ol>
      ...
      <ul className="list-disc pl-6 ">
        ...
        <li>
          ...
          consulting your printing company
        </li>
      </ul>
